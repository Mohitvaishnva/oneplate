...
class HotelResponseScreen extends StatefulWidget {
  const HotelResponseScreen({super.key});

  @override
  State<HotelResponseScreen> createState() => _HotelResponseScreenState();
}

class _HotelResponseScreenState extends State<HotelResponseScreen> {
        ...
        if (notificationsSnapshot.exists) {
          ...
          notificationsData.forEach((key, value) {
            try {
              ...
              // Only show notifications for hotel donors
              if (notification['donorType'] == 'hotel') {
