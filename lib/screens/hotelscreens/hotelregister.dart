...
class _HotelRegisterScreenState extends State<HotelRegisterScreen> {
  ...
  String _selectedFoodType = 'Both';
  bool _isLoading = false;

  final List<String> _foodTypes = ['Veg', 'Non-Veg', 'Both'];
  ...
  Future<void> _register() async {
    if (_formKey.currentState!.validate()) {
      ...
      if (result.success && result.user != null) {
        ...
        // Create Hotel object
        final hotel = models.Hotel(
          uid: FirebaseService.currentUserId!,
          name: _hotelNameController.text.trim(),
          licenseNumber: _licenseController.text.trim(),
          cuisine: [_selectedFoodType],
        ...
        // Save both User and Hotel to database
        try {
          await FirebaseService.saveUser(user);
          await FirebaseService.saveHotel(hotel);
                                  ...
                                  return DropdownMenuItem<String>(
                                    ...
                                    child: Row(
                                      children: [
                                        Icon(
                                          type == 'Veg' ? Icons.eco : 
                                          type == 'Non-Veg' ? Icons.restaurant : 
                                          Icons.restaurant_menu,
                                          color: type == 'Veg' ? Colors.green : 
                                                 type == 'Non-Veg' ? Colors.red : 
